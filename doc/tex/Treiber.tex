...
\begin{listing} [H]
\caption{\texttt{waveshare\_driver\_poll}}
\label{lst:waveshare_driver_poll}
\begin{minted} [frame=lines, framesep=2mm, fontsize=\footnotesize, linenos] {c}
unsigned int waveshare_driver_poll (struct file *driverinstance, 
...
\begin{listing} [H]
\caption{\texttt{waveshare\_sysfs\_read}}
\label{lst:waveshare_sysfs_read}
\begin{minted} [frame=lines, framesep=2mm, fontsize=\footnotesize, linenos] {c}
static ssize_t waveshare_sysfs_read (struct device *dev, struct device_attribute *attr, 
  char *buf) {
...
\begin{listing} [H]
\caption{\texttt{waveshare\_sysfs\_write}}
\label{lst:waveshare_sysfs_write}
\begin{minted} [frame=lines, framesep=2mm, fontsize=\footnotesize, linenos] {c}
static ssize_t waveshare_sysfs_write (struct device *dev, struct device_attribute *attr, 
